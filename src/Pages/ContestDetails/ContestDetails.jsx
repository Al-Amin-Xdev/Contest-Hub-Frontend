...
//   // 2️⃣ add the !registrationDoneRef.current check here
//   if (
//     params.get("payment") === "success" &&
//     userData &&
//     contest &&
//     !registrationDoneRef.current // ✅ this prevents running multiple times
//   ) {
//     registrationDoneRef.current = true; // 3️⃣ mark as done
